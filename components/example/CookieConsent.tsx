 ...
 * @returns {React.ReactNode} cookie consent component
 */
"use client";
...
export function CookieConsentContext({
  ...
  function save() {
    setCookie(
      ...
      `customized:{analytics:${temp.analytics},marketing:${temp.analytics}}`,
      {
        maxAge: 365 * 24 * 60 * 60,
        sameSite: "lax",
      }
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTemp((s) => ({ ...s, analytics: e.target.checked }))
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTemp((s) => ({ ...s, marketing: e.target.checked }))
                  }
                />
              </div>
            </div>
